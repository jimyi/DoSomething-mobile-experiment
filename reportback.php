...
<?php
		//When the page is first loaded -- Not submitted
		}
		 else 
		{		
			if($_POST[intsupplies]=='' or $_POST[intpeople]=='')
			{
			?>
			<div data-role="fieldcontain">
			...
			else
			{
				...
				mysql_query("Insert into reportback_staples values('','$_POST[intsupplies]','$_POST[intpeople]','$_POST[drivedetails]')");						
	?>
		<div data-role="fieldcontain">
