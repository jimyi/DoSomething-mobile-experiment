	...
	<div data-role="page">
		...
		<div data-role="content">
			...
			<ul id="tip_list">
				...
				<li>Donate the Supplies: Check out our Store Locator on StaplesForStudents.org to find the closest Staples and donate your supplies.</li>
				<li>Report Back: Don't forget to let us know all about your success. Submit your drive on the Do Something Projects page at DoSomething.org/projects for the chance to win school supplies signed by the stars of ABC Family's Pretty Little Liars.</li>
			</ul>
		</div><!-- /content -->
